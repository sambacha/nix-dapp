...
import { storageKey } from "../nix-theme"
import { networkId, rpcUrl } from "./web3"

const {
  REACT_APP_INFURA_KEY,
  REACT_APP_APP_NAME = "web3 Userpage",
  REACT_APP_APP_URL = "https://manifoldfinance.com",
  REACT_APP_CONTACT_EMAIL = "janitor@manifoldfinance.com",
} = process.env
